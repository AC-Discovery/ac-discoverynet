  ...
  return (
    <section className="relative bg-white/21 overflow-hidden">
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-10 h-80 sm:h-96 md:h-112 lg:h-128 flex items-center justify-center">
        <h1
          className="absolute inset-0 flex items-center justify-center font-extrabold uppercase tracking-tight text-5xl sm:text-6xl md:text-7xl lg:text-[9rem] leading-[0.95] text-center select-none pointer-events-none"
          style={{
