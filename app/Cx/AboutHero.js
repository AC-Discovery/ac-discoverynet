  ...
  return (
    <section className="relative bg-[#1f1f1f] overflow-hidden">
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-10 h-80 sm:h-96 md:h-112 lg:h-128 flex items-center justify-center">
        ...
        {/* transparent circle */}
        <div className="relative w-44 h-44 sm:w-52 sm:h-52 md:w-60 md:h-60 lg:w-64 lg:h-64 rounded-full bg-[#2484C6]/65 border border-white/20 flex items-center justify-center">
          <p className="relative z-10 text-white text-sm sm:text-base font-medium tracking-wide">
            Solutions Oriented
          </p>
        </div>
      </div>
